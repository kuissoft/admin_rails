...
class TokensControllerTest < ActionController::TestCase
  ...
  test "should create token" do
    assert_difference('Token.count') do
      post :create, token: { session_id: @token.session_id, token_id: @token.token_id, user_id: @token.user_id }
    end
  ...
  test "should update token" do
    patch :update, id: @token, token: { session_id: @token.session_id, token_id: @token.token_id, user_id: @token.user_id }
    assert_redirected_to token_path(assigns(:token))
  end
