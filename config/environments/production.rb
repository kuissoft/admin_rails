RemoteAssistant::Application.configure do
  ...
  config.logger = ActiveSupport::TaggedLogging.new(Logger.new('log/remote_assistant_production.log'))
  ...
  config.action_mailer.default_url_options = {host: "http://remoteassistant.me"}

  config.action_mailer.smtp_settings = {
    :authentication       => "login",
    :enable_starttls_auto => true,
    :user_name            => "robot@remoteassistant.me",
    :password             => "3UciCstnBf",
